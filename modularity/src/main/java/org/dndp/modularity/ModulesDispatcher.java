...
public class ModulesDispatcher {
    ...
    public static void main(String... args) {
        ...
        for (Module module : brokenModules) {
            System.err.println("Uszkodzony moduł: " + module.getEntryPoint() + " " + module.getMainJarFile() + " " + module.getModuleName());
        }
        for (Module module : registeredModules) {
            System.out.println("Zarejestrowany moduł: " + module.getEntryPoint() + " " + module.getMainJarFile() + " " + module.getModuleName());
        }
    }
}
